...
if(rd.analoginstatus==2):
    ...
    value=list(rd.aidatach1)#the ch1 scope data as c_char_p(4096)  don't use rd.aidatach1.value
    plt.plot(value)
    value=list(rd.aidatach2)#the ch2 scope data as c_char_p(4096)  don't use rd.aidatach1.value
    plt.plot(value)
