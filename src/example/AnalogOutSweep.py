...
rd.AnalogOutNodeSweepFreEnableSet(ch,True)
rd.AnalogOutNodeSweepFreSet(ch,1000,100000,0.001)
#rd.AnalogOutNodeSweepAmpEnableSet(ch,True)
#rd.AnalogOutNodeSweepAmpSet(ch,0,5,0.1)
